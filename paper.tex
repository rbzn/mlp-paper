...
\subsubsection{Identifier Retrieval}
\label{ir}
...
% \paragraph{} We than took the pattern matching approach as a baseline for our ranked
% retrievals sets as these patterns cover most common definition relations we
% found so far.
