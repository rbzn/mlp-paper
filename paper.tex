...
In combination with the Stratosphere system \todo{[HSC: NEED REFERENCE]}
...
terms: \todo{[HSC: here you should refer to the table]}
...
\todo[inline]{[HSC: Explain */DT in detail.] describe the process: extraction of identifiers, 
how to identify the description? Looking for space or using POS tags?}
...
\todo{HSC: The following two sentences need to be merged and explained further.
Also, paragraphs need to have more than one sentence. Fix this.}
...
\todo{Fix two (?) dates in reference [3].}
