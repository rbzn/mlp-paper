...
available.
We calculate the probablities for correct identifier definition tuples based
on part-of-speech (POS) tagged based distance metrics.
\todo{rewrite sentences to make it process more clear}
 The motivation for our
choice is that readers usually extract identifier definitions from context
